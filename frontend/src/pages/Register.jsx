...
export default function Register({ onSwitchToLogin }) {
  ...
  const inputStyle = (name) => ({
    ...
    boxShadow: focused===name ? "0 0 0 4px rgba(45,212,191,0.08)" : "0 1px 3px rgba(0,0,0,0.04)",
        ...
        {step === 1 && (
          <>
            ...
            <button onClick={proceedToDetails} style={{
              ...
              boxShadow:selectedRole?"0 4px 14px rgba(45,212,191,0.3)":"none",
              transition:"all 0.2s",
            }}>
        ...
        {step === 2 && (
          <>
            <button onClick={() => setStep(1)}
              style={{display:"flex",alignItems:"center",gap:10,width:"100%",marginBottom:20,padding:"12px 16px",borderRadius:12,cursor:"pointer",textAlign:"left",background:"var(--accent-dim)",border:`1.5px solid rgba(45,212,191,0.15)`}}>
